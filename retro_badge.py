...
COMPANY_NAME = "FashionFrame"
NAME = "Lacey (Any)"
BLURB1 = "Software   Engineer"
BLURB2 = "Looking    for work!"
BLURB3 = "Rhythm game nerd"

QR_TEXT = "https://github.com/FashionFrame"

IMAGE_NAME = "tuftypfp.jpg"
...
def show_photo():
    ...
    # Decode the JPEG
    j.decode(BORDER_SIZE + PADDING - 3, HEIGHT - (BORDER_SIZE + PADDING) - 125, jpegdec.JPEG_SCALE_HALF)
